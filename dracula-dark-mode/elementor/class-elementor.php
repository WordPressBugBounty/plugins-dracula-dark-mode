...
class Dracula_Elementor
{
    ...
    public function editor_scripts()
    {
        ...
        wp_enqueue_script('dracula-elementor-editor', DRACULA_ASSETS . '/js/elementor-editor.js', ['wp-components'], DRACULA_VERSION, true);
        wp_localize_script('dracula-elementor-editor', 'dracula', Dracula_Enqueue::instance()->get_localize_data());
    }
